...
export default function CharactersPage() {
  ...
  const filtered = characters
    ...
    .sort((a, b) =>
      sort === "vit" ? b.vit - a.vit : parseFloat(b.mc.replace(/[^0-9.]/g, "")) - parseFloat(a.mc.replace(/[^0-9.]/g, ""))
    );
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-3 mb-8">
            <input
              ...
              className="flex-1 bg-bone border-[3px] border-ink px-4 py-3 font-mono font-bold text-[13px] outline-none focus:bg-sun"
            />
          ...
          {filtered.length === 0 ? (
            <div className="border-[3px] border-ink p-10 text-center font-mono text-[12px] font-extrabold uppercase opacity-70 bg-bone shadow-[6px_6px_0_0_#0a0a0a]">
              no creatures matching that filter. they might be dead.
            </div>
          ) : (
