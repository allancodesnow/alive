...
// Seed data for demo
const seedCharacters: Omit<Character, "id">[] = [
  {
    tokenAddress: "0x1234567890abcdef1234567890abcdef12345678",
    name: "Pepe The Immortal",
    ticker: "PEPE",
    creator: "0xdead000000000000000000000000000000000001",
    personality: "FERAL",
    mood: "CHAOTIC",
    bio: "The original meme lord. Refuses to die since 2016. Has outlived every prediction of his demise.",
    vitality: 8500,
    hp: 8500,
    holders: 4200,
    marketCap: "420000",
    avatarUrl: "https://i.imgur.com/PYs9JDx.png",
    graduated: true,
    critical: false,
    walletEnabled: true,
    treasuryBalanceOkb: "125.5",
  ...
  },
  {
    ...
    name: "Wojak Eternal",
    ticker: "WOJAK",
    creator: "0xdead000000000000000000000000000000000002",
    personality: "COPIUM",
    mood: "HOPEFUL",
    bio: "Forever feeling. The face of every emotion. Currently processing the market.",
    vitality: 6200,
    hp: 6200,
    holders: 1850,
    marketCap: "185000",
    avatarUrl: "https://i.imgur.com/6ADLUG4.png",
    graduated: true,
    critical: false,
    walletEnabled: true,
    treasuryBalanceOkb: "45.2",
    createdAt: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000),
    updatedAt: new Date(),
  },
  {
    tokenAddress: "0x567890abcdef1234567890abcdef123456789012",
    name: "Gigachad Prime",
    ticker: "GIGA",
    creator: "0xdead000000000000000000000000000000000003",
    personality: "ALPHA",
    mood: "DOMINANT",
    bio: "Yes, I exist. No, I will not elaborate. Built different. Stays winning.",
    vitality: 9200,
    hp: 9200,
    holders: 3100,
    marketCap: "310000",
    avatarUrl: "https://i.imgur.com/mYrLxCT.png",
    graduated: true,
    critical: false,
    walletEnabled: true,
    treasuryBalanceOkb: "89.7",
    createdAt: new Date(Date.now() - 10 * 24 * 60 * 60 * 1000),
    updatedAt: new Date(),
  },
  {
    tokenAddress: "0x890abcdef1234567890abcdef12345678901234",
    name: "Doge Undying",
    ticker: "DOGE2",
    creator: "0xdead000000000000000000000000000000000004",
    personality: "WHOLESOME",
    mood: "FRIENDLY",
    bio: "Much alive. Very survive. The goodest boy in crypto. Still here after all these years.",
    vitality: 7800,
    hp: 7800,
    holders: 5600,
    marketCap: "560000",
    avatarUrl: "https://i.imgur.com/Xwj3C8v.png",
    graduated: true,
    critical: false,
    walletEnabled: true,
    treasuryBalanceOkb: "156.3",
  ...
  },
  {
    ...
    name: "Schizo Cat",
    ticker: "SCAT",
    creator: "0xdead000000000000000000000000000000000005",
    personality: "SCHIZO",
    mood: "UNHINGED",
    bio: "THE WALLS ARE TALKING AND THEY'RE BULLISH. Trust the plan. The chart is a psyop. We're all gonna make it (or are we?).",
    vitality: 4100,
    hp: 4100,
    holders: 890,
    marketCap: "89000",
    avatarUrl: "https://i.imgur.com/QvKcYYK.png",
    graduated: false,
    critical: false,
    walletEnabled: true,
    treasuryBalanceOkb: "12.8",
  ...
  },
  {
    ...
    name: "Menace Bean",
    ticker: "BEAN",
    creator: "0xdead000000000000000000000000000000000006",
    personality: "MENACE",
    mood: "THREATENING",
    bio: "I am the danger. The one who rugs. Coming for your liquidity and your peace of mind.",
    vitality: 2800,
    hp: 2800,
    holders: 420,
    marketCap: "42000",
    avatarUrl: "https://i.imgur.com/Y5y5k5y.png",
    graduated: false,
    critical: true,
    walletEnabled: true,
    treasuryBalanceOkb: "5.2",
